...
public class NavigationDrawerActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get the image view
        final ImageView imageView = (ImageView)findViewById(R.id.imageViewLocker);
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN: {
                        ...
                        if(!imageButtonLockPressed) {
                            imageView.setImageResource(R.drawable.lock_sleek_red);
                            imageButtonLockPressed=true;
                        }else{
                            imageView.setImageResource(R.drawable.lock_sleek_on);
